...
const items = [
    <div className="item px-4" data-value="1">
    ...
    <div className="item px-4" data-value="2">
    ...
    <div className="item px-4" data-value="3">
    ...
    <div className="item px-4" data-value="4">
    ...
    <div className="item px-4" data-value="5">
    ...
    <div className="item px-4" data-value="6">
    ...
    <div className="item px-4" data-value="7">
    ...
    <div className="item px-4" data-value="8">
    ...
    <div className="item px-4" data-value="9">
    ...
    <div className="item px-4" data-value="10">
    ...
    <div className="item px-4" data-value="11">
    ...
    <div className="item px-4" data-value="12">
    ...
    <div className="item px-4" data-value="13" >
